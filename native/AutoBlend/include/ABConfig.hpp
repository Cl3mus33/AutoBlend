...
struct ABParams {
    ...
    std::vector<std::wstring> meshBlacklist { LR"(*\glass\*)", LR"(*\ice\*)", LR"(*\trees\*)", LR"(*\actors\*)", LR"(*\roads\*)", LR"(*\dungeons\*)", LR"(*\effects\*)", LR"(*\magic\*)", LR"(*\weapons\*)" };
    std::vector<std::wstring> editorIdBlacklistKeywords { L"ice", L"frozen", L"glass", L"unique", L"wet", L"road", L"cave", L"mine" };
